...
namespace Prolunteer.DataAccess.Migrations
{
    ...
    [Migration("20210825125237_Initial migration")]
            ...
            modelBuilder.Entity("Prolunteer.Entities.UserCertificationDocument", b =>
                {
                    ...
                    b.Property<int?>("UserCertificationCertificationId")
                        .HasColumnType("int");

                    b.Property<Guid?>("UserCertificationUserId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UserCertificationUserId", "UserCertificationCertificationId");
            ...
            modelBuilder.Entity("Prolunteer.Entities.UserCertificationDocument", b =>
                {
                    b.HasOne("Prolunteer.Entities.UserCertification", "UserCertification")
                        .WithMany()
                        .HasForeignKey("UserCertificationUserId", "UserCertificationCertificationId");
